...
def run():
    """
    Główna funkcja widoku Wymiarowania na Ściskanie ze Zginaniem.
    """
    ...
    st.markdown(
        ...
        <div style="text-align:center; margin-top:0.4rem; margin-bottom:0rem;">
            <span style="font-size:42px; font-weight:800; letter-spacing:1px; color:#dddddd;">
                WYMIAROWANIE ELEMENTÓW ŚCISKANYCH ZE ZGINANIEM
            </span>
        </div>
    ...
    with tabs[0]:
        load_and_run_module("WymiarowaniePrzekrojeProstokatne.py")

    with tabs[1]:
        load_and_run_module("WymiarowaniePrzekrojeOkragle.py")
